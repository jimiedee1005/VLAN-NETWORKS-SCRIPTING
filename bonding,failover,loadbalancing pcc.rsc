...
add action=mark-connection chain=prerouting dst-address-type=!local new-connection-mark=wan1_conn passthrough=yes per-connection-classifier=\
    both-addresses-and-ports:4/0 src-address=192.168.10.1/24
add action=mark-connection chain=prerouting dst-address-type=!local new-connection-mark=wan2_conn passthrough=yes per-connection-classifier=\
    both-addresses-and-ports:4/1 src-address=192.168.10.1/24
add action=mark-connection chain=prerouting dst-address-type=!local new-connection-mark=wan3_conn passthrough=yes per-connection-classifier=\
    both-addresses-and-ports:4/2 src-address=192.168.10.1/24
add action=mark-connection chain=prerouting dst-address-type=!local new-connection-mark=wan4_conn passthrough=yes per-connection-classifier=\
    both-addresses-and-ports:4/3 src-address=192.168.10.1/24

add action=mark-routing chain=prerouting connection-mark=wan1_conn new-routing-mark=to_wan1 passthrough=yes src-address=192.168.10.1/24
add action=mark-routing chain=prerouting connection-mark=wan2_conn new-routing-mark=to_wan2 passthrough=yes src-address=192.168.10.1/24
add action=mark-routing chain=prerouting connection-mark=wan3_conn new-routing-mark=to_wan3 passthrough=yes src-address=192.168.10.1/24
add action=mark-routing chain=prerouting connection-mark=wan4_conn new-routing-mark=to_wan4 passthrough=yes src-address=192.168.10.1/24
}
